...
-doc "Encode a 16-bit big-endian integer attribute (matches C htons).".
-spec encode_u16(nla_type(), non_neg_integer()) -> <<_:32, _:_*8>>.
encode_u16(Type, Val) when is_integer(Val), Val >= 0 ->
    encode(Type, <<Val:16/big>>).
