...
ir_bitwise(_) ->
    ...
    %% len=4
    ?assertMatch({3, <<4:32/big>>}, lists:keyfind(3, 1, Attrs)).
...
ir_lookup(_) ->
    ...
    %% set name
    ?assertMatch({1, <<"banlist", 0>>}, lists:keyfind(1, 1, Attrs)).
...
ir_snat(_) ->
    ...
    ?assertMatch({2, <<2:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% reg_addr_min=1
    ?assertMatch({3, <<1:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% reg_proto_min=2
    ?assertMatch({5, <<2:32/big>>}, lists:keyfind(5, 1, Attrs)).
...
ir_exthdr(_) ->
    ...
    ?assertMatch({1, <<1:32/big>>}, lists:keyfind(1, 1, Attrs)),
    %% type=6
    ?assertMatch({2, <<6:8>>}, lists:keyfind(2, 1, Attrs)),
    %% offset=2
    ?assertMatch({3, <<2:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% len=2
    ?assertMatch({4, <<2:32/big>>}, lists:keyfind(4, 1, Attrs)).
...
ir_byteorder(_) ->
    ...
    ?assertMatch({2, <<1:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% op=0 (hton)
    ?assertMatch({3, <<0:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% len=4
...
ir_fib(_) ->
    ...
    ?assertMatch({2, <<2:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% flags=3
    ?assertMatch({3, <<3:32/big>>}, lists:keyfind(3, 1, Attrs)).
...
ir_dynset(_) ->
    ...
    %% set_name
    ?assertMatch({1, <<"myset", 0>>}, lists:keyfind(1, 1, Attrs)),
    %% op=0 (add)
    ?assertMatch({3, <<0:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% sreg_key=1
...
ir_connlimit(_) ->
    ...
    %% count=100
    ?assertMatch({1, <<100:32/big>>}, lists:keyfind(1, 1, Attrs)),
    %% flags=0
    ?assertMatch({2, <<0:32/big>>}, lists:keyfind(2, 1, Attrs)).
...
ir_inner(_) ->
    ...
    ?assertMatch({2, <<1:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% hdrsize=20
    ?assertMatch({4, <<20:32/big>>}, lists:keyfind(4, 1, Attrs)).
...
ir_numgen(_) ->
    ...
    ?assertMatch({1, <<1:32/big>>}, lists:keyfind(1, 1, Attrs)),
    %% modulus=4
    ?assertMatch({2, <<4:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% type=0 (inc)
    ?assertMatch({3, <<0:32/big>>}, lists:keyfind(3, 1, Attrs)).
...
ir_offload(_) ->
    ...
    %% table_name
    ?assertMatch({1, <<"ft0", 0>>}, lists:keyfind(1, 1, Attrs)).
...
ir_synproxy(_) ->
    ...
    %% mss=1460
    ?assertMatch({1, <<1460:16/big>>}, lists:keyfind(1, 1, Attrs)),
    %% wscale=7
    ?assertMatch({2, <<7:8>>}, lists:keyfind(2, 1, Attrs)),
    %% flags=3
    ?assertMatch({3, <<3:32/big>>}, lists:keyfind(3, 1, Attrs)).
...
ir_xfrm(_) ->
    ...
    %% key=0
    ?assertMatch({2, <<0:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% dir=0 (in) — u8, not u32. nft CLI uses nftnl_expr_set_u8().
    ?assertMatch({3, <<0:8>>}, lists:keyfind(3, 1, Attrs)).
...
ir_ip6_saddr(_) ->
    ...
    ?assertMatch({2, <<1:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% offset=8
    ?assertMatch({3, <<8:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% len=16
    ?assertMatch({4, <<16:32/big>>}, lists:keyfind(4, 1, Attrs)).
...
ir_ip6_daddr(_) ->
    ...
    ?assertMatch({2, <<1:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% offset=24
    ?assertMatch({3, <<24:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% len=16
    ?assertMatch({4, <<16:32/big>>}, lists:keyfind(4, 1, Attrs)).
...
ir_ip6_next_header(_) ->
    ...
    ?assertMatch({2, <<1:32/big>>}, lists:keyfind(2, 1, Attrs)),
    %% offset=6
    ?assertMatch({3, <<6:32/big>>}, lists:keyfind(3, 1, Attrs)),
    %% len=1
    ?assertMatch({4, <<1:32/big>>}, lists:keyfind(4, 1, Attrs)).
