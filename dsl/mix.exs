  ...
  def project do
    [
      ...
      docs: [
        ...
        groups_for_modules: [
          "DSL Entry": [Erlkoenig.Stack, Erlkoenig.DSL, Erlkoenig.Capabilities],
          Builders: [
            Erlkoenig.Container,
          ...
          "Mix Tasks": [Mix.Tasks.Erlkoenig.Compile, Mix.Tasks.Erlkoenig.Validate]
        ]
      ]
    ]
  end
